...
[`light-projection.mp4`](../public/media/light-projection.mp4)는 포레스트와 리액터의 빛에 사용하는 어두운 영상 루프입니다. 청록·보라·은색 곡면이 천천히 움직이고 그 사이에 검은 여백이 남습니다. 모니터 영상과 별도의 수식으로 생성하며 외부 영상을 사용하지 않습니다. 아래는 현재 파일의 규격과 생성·검증 방법입니다.
