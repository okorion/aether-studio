...
장치의 가장 위쪽 덮개를 얇은 천장판에 맞추고, 비늘 표면의 동심원 소용돌이를 제거했습니다. 지하실은 중앙 O와 수면을 비운 양측 서비스 홀로 재구성했으며, 숲의 밝고 선명한 영상 패턴은 어두운 청록·먹보라 사틴 반사로 바꿨습니다.
...
- 지하실 양측에 기단·캐비닛·프레임·배관·플랜지·작은 상태등을 배치했습니다. 데스크톱/모바일/소프트웨어에서 한쪽당 5/4/3개 베이를 사용합니다. 중앙 좌우 4.5 단위 안쪽에는 새 설비를 두지 않습니다. 무작위 잔해는 가장자리로 줄였습니다.
- 비늘의 방사형 회전과 별도 나선 입자를 제거했습니다. 금속 육각 타일은 넓고 얕은 방향성 굴곡을 유지하며 마우스 위치에서 들림·반사광이 반응합니다. 지하 O로 모이는 스크롤 입자 흐름은 기존 구현을 유지합니다.
...
- 새 설비는 7개 InstancedMesh로 묶었습니다(기존 4개 대비 +3). 대신 비늘의 별도 입자 draw를 제거했습니다. 수면 반사, 모니터 굴절 캡처, 전체 차폐 시 패스 생략 정책은 유지합니다.
...
| 지점 | 변경 전 | 변경 후 | 판단 포인트 |
| --- | --- | --- | --- |
| 0% | ![변경 전 상단 숲 · 어두운 영상](screenshots/chamber-art/before/scroll-000.jpg) | ![변경 후 상단 숲 · 어두운 영상](screenshots/chamber-art/after/scroll-000.jpg) | 상단 숲 · 어두운 영상 |
| 14.5% | ![변경 전 숲에서 소개로 넘어가는 경계](screenshots/chamber-art/before/scroll-145.jpg) | ![변경 후 숲에서 소개로 넘어가는 경계](screenshots/chamber-art/after/scroll-145.jpg) | 숲에서 소개로 넘어가는 경계 |
...
| 70% | ![변경 전 장치 O와 넓은 수면](screenshots/chamber-art/before/scroll-700.jpg) | ![변경 후 장치 O와 넓은 수면](screenshots/chamber-art/after/scroll-700.jpg) | 장치 O와 넓은 수면 |
| 72% | ![변경 전 장치 바닥](screenshots/chamber-art/before/scroll-720.jpg) | ![변경 후 장치 바닥](screenshots/chamber-art/after/scroll-720.jpg) | 장치 바닥 |
...
| 80% | ![변경 전 소용돌이를 제거한 비늘](screenshots/chamber-art/before/scroll-800.jpg) | ![변경 후 소용돌이를 제거한 비늘](screenshots/chamber-art/after/scroll-800.jpg) | 소용돌이를 제거한 비늘 |
| 85% | ![변경 전 비늘 굴곡](screenshots/chamber-art/before/scroll-850.jpg) | ![변경 후 비늘 굴곡](screenshots/chamber-art/after/scroll-850.jpg) | 비늘 굴곡 |
| 90% | ![변경 전 비늘과 하부 숲 경계](screenshots/chamber-art/before/scroll-900.jpg) | ![변경 후 비늘과 하부 숲 경계](screenshots/chamber-art/after/scroll-900.jpg) | 비늘과 하부 숲 경계 |
| 98% | ![변경 전 하단 숲 · 어두운 영상](screenshots/chamber-art/before/scroll-980.jpg) | ![변경 후 하단 숲 · 어두운 영상](screenshots/chamber-art/after/scroll-980.jpg) | 하단 숲 · 어두운 영상 |

## 검증

- `npm run lint`, `npm run typecheck`, `npm run build`, `git diff --check` 통과.
- Playwright **68개 통과**(4.4분): 데스크톱·모바일·WebGL 대체 화면, 정·역방향 24지점, 천장 높이·두께·덮개 접점과 실제 depth 차폐, 하부 진입 시 장치 가림과 역진입 복원, 비늘·장치·숲 마우스 픽셀 변화, 영상 재생·정지·실패 처리.
...
영상과 새 공간을 포함한 이번 표본에서 긴 프레임은 없었습니다. 새 설비가 여러 캡처에 함께 보이는 순간의 draw 비용은 증가했습니다. GPU 시간은 방향별로 일관되게 감소하지 않았으며, 1회 표본을 통계적인 성능 향상으로 해석하지 않습니다.
