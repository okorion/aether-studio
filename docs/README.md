...
| [모니터 설정과 입자 합류 경로](scene-flow-and-monitors.md) | 모니터 추가·삭제·영상·모델 설정, 포레스트·꽃의 경계 이동 |
...
| [서드파티 자료](../THIRD_PARTY_NOTICES.md) | 글꼴·CC0 영상·본 컬럼 메시의 출처와 이용 조건 |

## 변경과 측정 기록

| 기록 | 다룬 문제·변경 |
| --- | --- |
| [포레스트 입자와 하단 진입](verification/forest-flow-2026-09-27.md) | 밀집 나무 제거, 보강 입자 분산·반짝임 억제, 체인 자체 회전, 하단 전환 시점 |
| [카메라 높이에 따른 입자 보강](height-assembly-2026-09-26.md) | 포레스트 축소·순차 보강, 꽃의 수직 이동·모니터 간격, 패널 정지 구간과 링 페이드 제거 |
| [스케일 패널 전환과 본 컬럼·포레스트 배치](scene-framing-2026-09-26.md) | 한 화면 분량의 정면 패널 전환, 나무 높이, 본 컬럼 단면과 체인 경로 |
| [장면 형상과 입력 반응](scene-motion-detail-2026-09-25.md) | 물결 관성·재유입, 본 컬럼 꼬임·꽃·체인, 수면 유지, 패널 뒤집힘, 포레스트 영상 간격 |
| [재질·유체 표현과 검증](graphics-detail-fidelity.md) | 글자 물살의 변형 폭, GPU 리액터 위치 이력, 금속 표면, 수면 반사와 전후 비교 |
| [포레스트 영상 배치와 장면 후속 수정](scene-spatial-followup.md) | 영상 곡면, 물살 정착, 체인 감김, 본 컬럼·꽃·O 형태, 스케일 장면 거리와 초기 포레스트 |
| [포레스트 영상 크기](forest-film-framing.md) | 숲 경계 부근의 곡면 영상 점유율과 전후 비교 |
...
| [본 컬럼 화면 안개](column-screen-haze.md) | 전체 뷰포트 비율에 따른 안개 범위, 포인터 걷힘·복구, 원래 색 보존 |
| [안개 잔상·리액터 조명·꽃 밀도](haze-reactor-flower-correction.md) | 안개 초기화 제거, 기체 잔상, 넓은 조명과 꽃 추가·원경 감김 간격 |
