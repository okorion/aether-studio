...
| 좌표·카메라·스크롤 경로 | [연속 여정](../continuous-journey.md), [실제 동작](../dynamic-motion.md), [입력 잠금](../mechanical-camera.md), [세로 입력](../transition-input.md) | [Journey](../../src/Journey.ts), [SceneInteraction](../../src/SceneInteraction.ts), [interaction 검사](../../tests/interaction.spec.ts), [device-pointer 검사](../../tests/device-pointer.spec.ts) |
