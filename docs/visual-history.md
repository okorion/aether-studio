...
| 단계 | 변경의 중심 | 대표 화면 |
| --- | --- | --- |
| [PR #1](https://github.com/okorion/aether-studio/pull/1) | 초기 금속 A 링·꼬리와 입자 배경, Work·Contact | 초기 스튜디오 |
| [PR #2](https://github.com/okorion/aether-studio/pull/2) | 링과 꼬리 결합, 스크롤 장면 확대, 은빛 흔적과 드래그 | 다섯 장면과 마우스 흔적 |
| [PR #3](https://github.com/okorion/aether-studio/pull/3) → [#4](https://github.com/okorion/aether-studio/pull/4) | 24단계 연속 중심 흐름, 카메라 수직 하강과 정지·역방향 사슬 | #4 병합본 |
...
기준: [`4ba178d`](https://github.com/okorion/aether-studio/commit/4ba178dba238455102b4731323488fe40d51c443) · 금속 A 링·꼬리, 입자 배경, 문서 안의 Work·Contact. [당시 설명](verification.md)
...
기준: [`a950b50`](https://github.com/okorion/aether-studio/commit/a950b50d186f225e900747263b1634ea9cb41451) · 링·꼬리 결합, 500svh 장면, 카메라 드래그·은빛 흔적. [당시 설명](visual-comparison.md)
...
기준: [`31ffdee`](https://github.com/okorion/aether-studio/commit/31ffdee24d8c0ce17692f46870650b9fd09922e3) · PR #3의 24단계 흐름에 실제 수직 하강·왕복 사슬·O 방향 보정. [당시 설명](dynamic-motion.md)
...
기준: [`f40a58f`](https://github.com/okorion/aether-studio/commit/f40a58fd07a6bf98fcb0184797b1d4dfcb280d33) · 척추 관절·사슬, 나선형 유리 모니터와 배경 굴절. [당시 설명](spine-monitors.md)
...
기준: [`ec640da`](https://github.com/okorion/aether-studio/commit/ec640daeef447b32a6df024739cae2851f4a7c5f) · PR #7의 숲·평면 문구·독립 지하층에 실제 MP4 두 편과 판 호버·클릭. [당시 설명](monitor-cinema.md)
...
기준: [`af57c87`](https://github.com/okorion/aether-studio/commit/af57c8788ea7b068d57c5f59d619963c65def51c) · 월드 공간 숲, 유기적 척추와 감기는 사슬, 지하 장치·단일 입자 O·전진 섬광. [당시 설명](living-worlds.md)
...
- [척추와 굴절 모니터](spine-monitors.md) · [층 전환](layered-transitions.md)
- [실제 영상·호버·프로젝트 열기](monitor-cinema.md)
- [입체 숲·척추·지하 장치](living-worlds.md)
