...
[Active Theory](https://activetheory.net/)의 공간 구성과 인터랙션을 참고했습니다. 제휴 프로젝트는 아니며, 해당 사이트의 소스·로고·모델·영상을 앱 자산으로 사용하지 않습니다. 모델과 자체 영상은 코드와 생성 스크립트로 만들며, 포레스트 배경에는 CC0 실사 영상을 편집해 함께 사용합니다. 비교 문서의 원본 캡처는 관찰 근거입니다.
