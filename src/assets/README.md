...
`lumbar-vertebra.json`은 Bill Lorensen의 **Visible Human Male - First lumbar vertebra**를 수정한 메시입니다.
...
배포본에도 `/asset-credits.txt`로 저작자와 라이선스를 제공합니다. 의학적 용도가 아닌 시각 연출용입니다.
