...
원본과 콘텐츠·해부학적 모델·영상은 다릅니다. 원본의 모델·실사 영상 품질이나 유사도 백분율을 보증하지 않습니다. 이후 입자·광원 반응은 [포인터 흐름 기록](particle-pointer-flow.md), 모니터 배치는 [장면 수정 기록](scene-reference-detail.md)에 정리했다.
